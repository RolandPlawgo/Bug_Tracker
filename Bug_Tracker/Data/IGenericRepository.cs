...
namespace Bug_Tracker.Data
{
        ...
        where TEntity : class
    {
        ...
        IEnumerable<TEntity> Get(string includeProperties = "", Expression<Func<TEntity, bool>>? filter = null, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>>? orderBy = null);
        /// <summary>
        ...
        /// <param name="orderBy">If it's null, the entities will not be ordered</param>
        IEnumerable<TEntity> Get(string includeProperties = "", List<Expression<Func<TEntity, bool>>>? filters = null, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>>? orderBy = null);
        /// <summary>
        ...
        /// <param name="filter">If it's null, no filtering will be performed and all entities will be returned</param>
        /// <param name="orderBy">If it's null, the entities will not be ordered</param>
        IEnumerable<TEntity> Get(int page, int elementsOnPage, out int pages, string includeProperties = "", Expression<Func<TEntity, bool>>? filter = null, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>>? orderBy = null);
        /// <summary>
        ...
        /// <param name="filters">If it's null, no filtering will be performed and all entities will be returned</param>
        /// <param name="orderBy">If it's null, the entities will not be ordered</param>
        IEnumerable<TEntity> Get(int page, int elementsOnPage, out int pages, string includeProperties = "", List<Expression<Func<TEntity, bool>>>? filters = null, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>>? orderBy = null);
        /// <summary>
        ...
        TEntity? GetEntity(Expression<Func<TEntity, bool>> filter, string includeProperties = "");
        /// <summary>
